...
# Music death sound
background_music = pygame.mixer.Sound("Survivor  Eye of the Tiger.mp3")
death_sound = pygame.mixer.Sound("Shotgun - QuickSounds.com.mp3")

# Positions of background images
basketball_image = pygame.image.load("basketball.png").convert()
basketball_position = [300,250]

basketball_image_1 = pygame.image.load("basketball.png").convert()
basketball_position_1 = [300,0]

basketball_image_2 = pygame.image.load("basketball.png").convert()
basketball_position_2 = [50,0]

basketball_image_3 = pygame.image.load("basketball.png").convert()
basketball_position_3 = [50,250]

basketball_image_4 = pygame.image.load("basketball.png").convert()
basketball_position_4 = [550,250]

basketball_image_5 = pygame.image.load("basketball.png").convert()
basketball_position_5 = [550,0]
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load("character_2.jpg").convert()
...
block = Block_2(140,60,720,40,RED)
all_sprites_list_1.add(block)
finish_block_list.add(block)

block = Block_1(500,10,550,70,BLACK)
all_sprites_list_1.add(block)
bad_block_list.add(block)
...
offset_y = 250
for i in range(2):
    block = Block_1(500,10,550,offset_y,BLACK)
    all_sprites_list_1.add(block)
    bad_block_list.add(block)
    offset_y += 200
...
offset_y = 150
for i in range(3):
    block = Block_1(800,10,150,offset_y,BLACK)
    all_sprites_list_1.add(block)
    bad_block_list.add(block)
    offset_y += 200
...
y = 525
for i in range(6):
    block = Block_1(10,50,350,y,BLACK)
    all_sprites_list_1.add(block)
    bad_block_list.add(block)
    y -= 100
...
while not done:
    ...
    screen.blit(basketball_image, basketball_position)
    screen.blit(basketball_image_1, basketball_position_1)
    screen.blit(basketball_image_2, basketball_position_2)
    screen.blit(basketball_image_3, basketball_position_3)
    screen.blit(basketball_image_4, basketball_position_4)
    screen.blit(basketball_image_5, basketball_position_5)
    ...
    pygame.draw.rect(screen, GREEN, [70, 70, 70, 50], 0)
    font = pygame.font.SysFont('Rock wall',50,True,False)
    text = font.render(str(countdown), True, BLACK)
    screen.blit(text, [83, 80])
    clock.tick(60)
